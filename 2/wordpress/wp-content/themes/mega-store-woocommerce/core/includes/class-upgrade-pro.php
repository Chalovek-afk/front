		...
		$manager->add_section(
			new Mega_Store_Woocommerce_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.misbahwp.com/products/megastore-wordpress-theme',
					'pro_demo_text'    => esc_html__( 'View Demo', 'mega-store-woocommerce' ),
					'pro_demo_url'     => 'https://demo.misbahwp.com/mega-store-woocommerce/',
					'priority'    => 1,
				)
			)
		);
